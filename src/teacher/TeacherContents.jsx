          ...
          open === true ?
            <div className='col-12 mt-3'>
              ...
              <div className='row'>
                ...
                <Square col="2" backgroundColor="white" to="/teacher-contents/QUIZS"><b><span >QUIZZES</span></b> </Square>
              </div>
              <div className='row'>
            ...
            <div className='col-12 mt-3'>
              ...
              <div className='row'>
                ...
                }
                {
                  linkType === "COMICS" ?
                    <React.Fragment>
                      <div className="col-3 p-2"><a target="_blank" href="http://madeinbrain.net/axebug/html/Chapter1/index.html"><img className='w-100' src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/ch1.png`} /></a></div>
                      <div className="col-3 p-2"><a target="_blank" href="http://madeinbrain.net/axebug/html/Chapter2v3/index.html"><img className='w-100' src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/ch2.png`} /></a></div>
                      <div className="col-3 p-2"><a target="_blank" href="http://madeinbrain.net/axebug/html/Chapter3/index.html"><img className='w-100' src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/ch3.png`} /></a></div>
                      <div className="col-3 p-2"><a target="_blank" href="http://madeinbrain.net/axebug/html/Chapter4/index.html"><img className='w-100' src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/ch4.png`} /></a></div>
                    </React.Fragment>
                    : null
                }
                {
                  linkType === "ACTIVTY" ?
                    <React.Fragment>
                      ...
                      <div className="col-3 p-2"><a target="_blank" href="http://madeinbrain.net/axebug/html/Activite1/index.html" rel="noreferrer"><img className='w-100' src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/ab1.png`} /></a>
                              <a className='mt-2 border border-success p-2 d-flex justify-content-center' target="_blank" href={`http://madeinbrain.net/pdf/Activite_1_Book_key.pdf`} rel="noreferrer">
                                <span>DOWNLOAD KEY</span>
                              </a>
                      </div>
                      <div className="col-3 p-2"><a target="_blank" href="http://madeinbrain.net/axebug/html/Activite2v3/index.html" rel="noreferrer"><img className='w-100' src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/ab2.png`} /></a>
                        <a target="_blank" href="https://axebug.s3.eu-central-1.amazonaws.com/pdf/Activite_2_Book_key.pdf">
                          <div className='mt-2 border border-success p-2 d-flex justify-content-center'><b>DOWNLOAD KEY</b></div></a></div>
                      <div className="col-3 p-2"><a target="_blank" href="http://madeinbrain.net/axebug/html/Activite3/index.html" rel="noreferrer"><img className='w-100' src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/ab3.png`} /></a>
                        <a target="_blank" href="https://axebug.s3.eu-central-1.amazonaws.com/pdf/Activite_3_Book_key.pdf">
                          <div className='mt-2 border border-success p-2 d-flex justify-content-center'><b>DOWNLOAD KEY</b></div></a></div>
                      <div className="col-3 p-2"><a target="_blank" href="http://madeinbrain.net/axebug/html/Activite4/index.html" rel="noreferrer"><img className='w-100' src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/ab4.png`} /></a>
                        <a target="_blank" href="https://axebug.s3.eu-central-1.amazonaws.com/pdf/Activite_4_Book_key.pdf">
                          <div className='mt-2 border border-success p-2 d-flex justify-content-center'><b>DOWNLOAD KEY</b></div></a></div>
                    </React.Fragment>
                    : null
                }
                {
                  linkType === "CONNECTION" ?
                    <React.Fragment>
                      <div className="col-3 p-2"><a target="_blank" href="http://madeinbrain.net/axebug/html/Mathematics/index.html" rel="noreferrer"><img className='w-100' src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/math.png`} /></a></div>
                      <div className="col-3 p-2"><a target="_blank" href="http://madeinbrain.net/axebug/html/Science/index.html" rel="noreferrer"><img className='w-100' src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/science.png`} /></a></div>
                    </React.Fragment>
                    : null
                }
              </div>
