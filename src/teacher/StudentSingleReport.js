...
export default function StudentSingleReport(params) {
    ...
    useEffect(() => {
        if (params.studentId !== 0 && params.examId !== 0) {
            document.body.style.backgroundColor = 'white';
            setReportData("createReport", { studentId: params.studentId, examId: params.examId })
            setStudentScore("studentScore", params.studentId)
        }
                        ...
                        reportData.exam ?
                            <div className='container m-5'>
                                <div className='row text-white bg-dark p-4'>
                                    <div className='col-6 text-white bg-dark d-flex justify-content-center'><h2><b><Link to="/" className='text-white'>AXEBUG REPORT</Link></b></h2></div>
