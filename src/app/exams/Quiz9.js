      ...
      <div className="card mt-5 mb-5">
        <div className="card-header">
          <div className="d-flex justify-content-center">
            <h1>
              <strong> QUIZ CHAPTER 3 EPISODE 9</strong>
            </h1>
          </div>
        </div>
                ...
                <div style={{ fontSize: "18pt" }}>
                  {pageNo === 0 ? (
                    <React.Fragment>
                      ...
                      <div className="row">
                        <strong>
                          1. Why did they go back to the headquarters?
                        </strong>
                      ...
                      <div className="row">
                        <strong>
                          3. How many stops will they visit according to their
                          route?
                        </strong>
                        <div className="form-check">
                          <input
                      ...
                      <div className="row">
                        <strong>
                          4. Why did Robug Colony have to leave their planet?
                        </strong>
                        <div className="form-check">
                          <input
                            className="form-check-input"
                          ...
                          <label
                            ...
                            htmlFor="flexRadioDefault1"
                          >
                            A) Because their ancestors couldn’t protect their
                            sources.
                          </label>
                        </div>
                        <div className="form-check">
                      ...
                      <div className="row">
                        <strong>
                          5. Which element does Robug Colony need to survive?
                        </strong>
                        <div className="form-check">
                          <input
                            className="form-check-input"
                  ...
                  {pageNo === 1 ? (
                    <React.Fragment>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/quiz_9_listeng.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      <div className="paragraf">
                        <strong>Robug 13: </strong> We geared up ‘ZZZ55’ for
                        this tough journey. .
                      </div>
                      <div className="paragraf">
                      ...
                      <div className="paragraf">
                        <strong>Robug 13: </strong>If this journey hits the nail
                        on the head, life in our colony will be{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>Axebug: </strong> We will hit the{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                          value={answer.result[0][1][2].student}
                      ...
                      <div className="paragraf">
                        <strong>Robug 13: </strong>Let’s go back to headquarters
                        and run through the checklist.
                      </div>
                      <div className="paragraf">
                        <strong>Axebug: </strong> All right. Let’s{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>ROBUG 13: </strong> That’s the milky way over
                        there.
                      </div>
                      <div className="paragraf">
                        <strong>Axebug: </strong> Where are we{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>Robug 13: </strong> This is where we are right
                        now. We are far away from the solar system.
                      </div>
                      <div className="paragraf">
                        <strong>Axebug: </strong> Where are we{" "}
                        <input
                      ...
                      <div className="paragraf">
                        <strong>Robug 13:</strong> You are heading to the m44
                        constellation.
                      </div>
                      <div className="paragraf">
                        <strong>Axebug:</strong> Ok. Which{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>Robug 13:</strong> We are on the m45
                        constellation.
                      </div>
                      <div className="paragraf">
                      ...
                      <div className="paragraf">
                        <strong>Axebug:</strong>It’s not going to be a short{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>Robug 13:</strong> ‘ZZZ55’ is{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>Axebug: </strong> Let’s Go On About The{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                  ...
                  {pageNo === 2 ? (
                    <React.Fragment>
                      ...
                      <div className="row">
                        <div className="col-2"> 1. Run through</div>
                        <div className="col-1">
                          <input
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>A. </strong> To become larger or grater.
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-2"> 2. Mistery</div>
                        <div className="col-1">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>B. </strong> Go through quickly.
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-2"> 3. Accord</div>
                        <div className="col-1">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>C. </strong> An unknown and curious thing, a
                            secret.
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-2"> 4. Grow</div>
                        <div className="col-1">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>D. </strong> Use something up.
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-2"> 5. Consume</div>
                        <div className="col-1">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>E. </strong> A formal agreement.
                          </div>
                        </div>
                      </div>
                    </React.Fragment>
                  ...
                  {pageNo === 4 ? (
                    <React.Fragment>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/c3_e9_pg4_p3.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/c3_e9_pg4_p6.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/c3_e9_pg5_p1.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/c3_e9_pg4_p7.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
