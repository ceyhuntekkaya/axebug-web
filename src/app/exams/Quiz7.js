        ...
        <div className="container">
            <div className="card mt-5 mb-5">
                ...
                <div className="card-header">
                    <div className="d-flex justify-content-center">
                        <h1>
                            <strong> QUIZ CHAPTER 2 EPISODE 7</strong>
                        </h1>
                    </div>
                </div>
                                ...
                                <div style={{fontSize: "18pt"}}>
                                    ...
                                    {pageNo === 1 ? (
                                        <React.Fragment>
                                            ...
                                            <div className="alert alert-dark" role="alert">
                                                ...
                                                >
                                                    <source
                                                        src={getFileUrl('OUIZ_7_B_LISTENING.mp3')}
                                                        type="audio/mpeg"
                                                    />
                                                </audio>
                                            </div>
                                            <div className="paragraf">
                                                <strong>WATCHMAN 1:</strong>Sixty{" "}
                                                <input
                                            ...
                                            <div className="paragraf">
                                                <strong>WATCHMAN 1:</strong> We are going to lock down
                                                the ship to it’s{" "}
                                                <input
                                                    className="form-input textformat"
                                                    type="text"
                                            ...
                                            <div className="paragraf">
                                                <strong>WATCHMAN 2: </strong>All set for{" "}
                                                <input
                                                    className="form-input textformat"
                                                    type="text"
                                            ...
                                            <div className="paragraf">
                                                <strong>WATCHMAN 1:</strong> Nine, eight, seven, six,
                                                five, four, three, two, one...
                                            </div>
                                            <div className="paragraf">
                                                <strong>WATCHMAN 1 and WATCHMAN 2: </strong>Lockdown
                                                completed!
                                            </div>
                                            <div className="paragraf">
                                                <strong>WATCHMAN 1: </strong>Let's{" "}
                                                <input
                                                    className="form-input textformat"
                                                    type="text"
                                            ...
                                            <div className="paragraf">
                                                <strong>Ladybug:</strong> Is this a joke? I want to go
                                                home.
                                            </div>
                                            <div className="paragraf">
                                            ...
                                            <div className="paragraf">
                                                <strong>Watchman 1:</strong> Did you{" "}
                                                <input
                                                    className="form-input textformat"
                                                    type="text"
                                            ...
                                            <div className="paragraf">
                                                <strong>Watchman 1 :</strong> Open the{" "}
                                                <input
                                                    className="form-input textformat"
                                                    type="text"
                                    ...
                                    {pageNo === 2 ? (
                                        <React.Fragment>
                                            ...
                                            <div className="row">
                                                <div className="col-2"> 1. Force</div>
                                                <div className="col-1">
                                                    <input
                                                ...
                                                <div className="col-9">
                                                    <div className="paragraf alert alert-success">
                                                        <strong>A. </strong> To pause or stop a disturbance,
                                                        mainly used in aircrafts or prisoner cells.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="col-2"> 2. Lock-Down</div>
                                                <div className="col-1">
                                                    <input
                                                        className="form-input w-100"
                                                        type="text"
                                                ...
                                                <div className="col-9">
                                                    <div className="paragraf alert alert-success">
                                                        <strong>B. </strong> A large wasp that can give you
                                                        a bad sting.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="col-2"> 3. Orbit</div>
                                                <div className="col-1">
                                                    <input
                                                        className="form-input w-100"
                                                        type="text"
                                                ...
                                                <div className="col-9">
                                                    <div className="paragraf alert alert-success">
                                                        <strong>C. </strong> A small room of two doors to
                                                        let passage through.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
                                                <div className="col-2"> 4. Hormet</div>
                                                <div className="col-1">
                                                    <input
                                                        className="form-input w-100"
                                                        type="text"
                                            ...
                                            <div className="row">
                                                <div className="col-2"> 5. Airlock-door</div>
                                                <div className="col-1">
                                                    <input
                                                        className="form-input w-100"
                                                        type="text"
                                                ...
                                                <div className="col-9">
                                                    <div className="paragraf alert alert-success">
                                                        <strong>E. </strong> An elliptical path or way,
                                                        especially in Space.
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    {pageNo === 3 ? (
                                        <React.Fragment>
                                            ...
                                            <div className="row">
                                                <div className="col-3"> 1. netpla</div>
                                                <div className="col-9">
                                                    <input
                                                        className="form-input textformat"
                                                        type="text"
                                            ...
                                            <div className="row">
                                                <div className="col-3"> 3. arthe</div>
                                                <div className="col-9">
                                                    <input
                                                        className="form-input textformat"
                                                        type="text"
                                            ...
                                            <div className="row">
                                                <div className="col-3"> 4. rolcont</div>
                                                <div className="col-9">
                                                    <input
                                                        className="form-input textformat"
                                                        type="text"
                                            ...
                                            <div className="row">
                                                <div className="col-3"> 5. heada</div>
                                                <div className="col-9">
                                                    <input
                                                        className="form-input textformat"
                                                        type="text"
                                            ...
                                            <div className="row">
                                                <div className="col-3"> 6. turecap</div>
                                                <div className="col-9">
                                                    <input
                                                        className="form-input textformat"
                                                        type="text"
                                            ...
                                            <div className="row">
                                                <div className="col-3"> 7. kingdoc</div>
                                                <div className="col-9">
                                                    <input
                                                        className="form-input textformat"
                                                        type="text"
                                            ...
                                            <div className="row">
                                                <div className="col-3"> 8. methel</div>
                                                <div className="col-9">
                                                    <input
                                                        className="form-input textformat"
                                                        type="text"
                                            ...
                                            <div className="row">
                                                <div className="col-3"> 9. suitspace</div>
                                                <div className="col-9">
                                                    <input
                                                        className="form-input textformat"
                                                        type="text"
                                            ...
                                            <div className="row">
                                                <div className="col-3"> 10. werto</div>
                                                <div className="col-9">
                                                    <input
                                                        className="form-input textformat"
                                                        type="text"
                                    ...
                                    {pageNo === 4 ? (
                                        <React.Fragment>
                                            ...
                                            <div className="alert alert-dark" role="alert">
                                                ...
                                                >
                                                    <source
                                                        src={getFileUrl('p078_001_c2_e7.mp3')}
                                                        type="audio/mpeg"
                                                    />
                                                </audio>
                                            </div>
                                            ...
                                            <div className="alert alert-dark" role="alert">
                                                ...
                                                >
                                                    <source
                                                        src={getFileUrl('p082_001_c2_e7.mp3')}
                                                        type="audio/mpeg"
                                                    />
                                                </audio>
                                            </div>
                                            ...
                                            <div className="alert alert-dark" role="alert">
                                                ...
                                                >
                                                    <source
                                                        src={getFileUrl('p087_001_c2_e7.mp3')}
                                                        type="audio/mpeg"
                                                    />
                                                </audio>
                                            </div>
                                            ...
                                            <div className="alert alert-dark" role="alert">
                                                ...
                                                >
                                                    <source
                                                        src={getFileUrl('p0104_001_c2_e7.mp3')}
                                                        type="audio/mpeg"
                                                    />
                                                </audio>
                                            </div>
