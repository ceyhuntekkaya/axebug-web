                                    ...
                                    <React.Fragment>
                                        <div>
                                            ...
                                            <div className="paragraf">
                                                ...
                                                e. Something which is not important for a person, but which means a lot
                                                to another
                                                person.<br/>
                                    ...
                                    <React.Fragment>
                                        <div>
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td> 6. Axebug crew went to the Robug Planet to visit historical
                                                        places.
                                                    </td>
                                                    <td><input
                                                        className="form-input textformat"
                                ...
                                {pageNo === 4 ? (
                                    <React.Fragment>
                                        <div>
                                            ...
                                            <div className="paragraf">
                                                <strong>Robug 13:</strong> These are our friends. From now on, they
                                                can <input
                                                className="form-input textformat"
                                                type="text"
                                                value={answer.result[1][0][10].student}
                                            ...
                                            <div className="paragraf">
                                                <strong>Robug 13:</strong> You have come a long way. Take a break. Eat
                                                and <input
                                                className="form-input textformat"
                                                type="text"
                                                value={answer.result[1][0][10].student}
