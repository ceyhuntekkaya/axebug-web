                ...
                <div style={{ fontSize: "18pt" }}>
                  {pageNo === 0 ? (
                    <React.Fragment>
                      ...
                      <div className="row">
                        <strong>
                          1. What does Watchman see behind the meteorites?
                        </strong>
                      ...
                      <div className="row">
                        <strong>
                          2. The watchman can __________ inside the ship.
                        </strong>
                        <div className="form-check">
                          <input
                            className="form-check-input"
                      ...
                      <div className="row">
                        <strong>
                          3. When will they take control of ZZZ55?
                        </strong>
                        <div className="form-check">
                          <input
                            className="form-check-input"
                      ...
                      <div className="row">
                        <strong>
                          5. The watchman switches to ______ mode.
                        </strong>
                        <div className="form-check">
                          <input
                            className="form-check-input"
                  ...
                  {pageNo === 1 ? (
                    <React.Fragment>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/OUIZ_5_B_LISTENING.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="paragraf">
                        <strong>WATCHMAN 2:</strong> Damn it! Look properly. You
                        are{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>WATCHMAN 1: </strong>That’s ok. If i miss out,
                        we have you afterall.
                      </div>
                      <div className="paragraf">
                        <strong>WATCHMAN 1: </strong> The seeker telescope is
                        our eye in space. The data in it records
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>WATCHMAN 2:</strong> We will see what it is when
                        we check the archives.
                      </div>
                      <div className="paragraf">
                        <strong>WATCHMAN 2: </strong>Keep{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                        ...
                        />{" "}
                        in outer space other than by the way.
                      </div>
                      <div className="paragraf">
                        <strong>WATCHMAN 2: </strong>This... Is This?
                      </div>
                      <div className="paragraf">
                        <strong>WATCHMAN 2:</strong> This is a{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>WATCHMAN 1: </strong>Here, i have reached the
                        archives. Now, leave
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>WATCHMAN 2:</strong> Allright. The name of the{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                  ...
                  {pageNo === 2 ? (
                    <React.Fragment>
                      ...
                      <div className="row">
                        <div className="col-2"> 4. Likely</div>
                        <div className="col-1">
                          <input
                            className="form-input w-100"
                            type="text"
                  ...
                  {pageNo === 4 ? (
                    <React.Fragment>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p016_001_c2_e5.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p027_001_c2_e5.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p035_003_c2_e5.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p039_001_c2_e5.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
