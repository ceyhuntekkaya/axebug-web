                  ...
                  <div style={{ fontSize: "18pt" }}>
                    {
                      pageNo === 0 ?
                        <React.Fragment>
                          ...
                          <div className='row'>
                            <strong>1. Axebug says “To answer for your question is ..........</strong>
                        ...
                        <React.Fragment>
                          ...
                          <div className="alert alert-dark" role="alert">
                            <audio controls className='w-100' style={{ backgroundColor: "black", height: 45 }}>
                              <source src={`http://madeinbrain.net/axebug/assets/quiz_listening_c1_e2.mp3`} type="audio/mpeg" />
                            </audio>
                          </div>
...

                    {
                      pageNo === 4 ?
                        ...
                        <React.Fragment>
                          ...
                          <div className="alert alert-dark" role="alert">
                            <audio controls className='w-100' style={{ backgroundColor: "black", height: 45 }}>
                              <source src={`http://madeinbrain.net/axebug/assets/p035_01_c1e2.mp3`} type="audio/mpeg" />
                            </audio>
                          </div>
                          ...
                          <div className="alert alert-dark" role="alert">
                            <audio controls className='w-100' style={{ backgroundColor: "black", height: 45 }}>
                              <source src={`http://madeinbrain.net/axebug/assets/p037_03_c1e2.mp3`} type="audio/mpeg" />
                            </audio>
                          </div>
                          <div className='border border-success p-3 mt-3'>
                          ...
                          <div className="alert alert-dark" role="alert">
                            <audio controls className='w-100' style={{ backgroundColor: "black", height: 45 }}>
                              <source src={`http://madeinbrain.net/axebug/assets/p054_01_c1e2.mp3`} type="audio/mpeg" />
                            </audio>
                          </div>
                          <div className='border border-success p-3 mt-3'>
                          ...
                          <div className="alert alert-dark" role="alert">
                            <audio controls className='w-100' style={{ backgroundColor: "black", height: 45 }}>
                              <source src={`http://madeinbrain.net/axebug/assets/p060_03_c1e2.mp3`} type="audio/mpeg" />
                            </audio>
                          </div>
                          <div className='border border-success p-3 mt-3'>
