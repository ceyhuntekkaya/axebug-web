    ...
    <div className="container">
      ...
      <div className="card-header">
        ...
        <div className="card-header">
          <div className="d-flex justify-content-center">
            <h1>
              <strong> QUIZ CHAPTER 2 EPISODE 6</strong>
            </h1>
          </div>
        </div>
                ...
                <div style={{ fontSize: "18pt" }}>
                  {pageNo === 0 ? (
                    <React.Fragment>
                      ...
                      <div className="row">
                        <strong>
                          2. What does Axebug explain wormhole with?
                        </strong>
                        <div className="form-check">
                          <input
                            className="form-check-input"
                      ...
                      <div className="row">
                        <strong>
                          4. They were in a ______ when they got out of the
                          hole.
                        </strong>
                        <div className="form-check">
                          <input
                  ...
                  {pageNo === 1 ? (
                    <React.Fragment>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/OUIZ_6_B_LISTENING.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      <div className="paragraf">
                        <strong>Axebug:</strong> Ahaa! This is exactly what a{" "}
                        <input
                      ...
                      <div className="paragraf">
                        <strong>Axebug: </strong> When we entered the sphere, we
                        passed millions of kilometers in a{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>Axebug: </strong>It is a piece of cake for me to
                        explain. Just give me a pen and paper.
                      </div>
                      <div className="paragraf">
                        <strong>Axebug: </strong>This is a{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>Axebug:</strong> And this is where we want to{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                      ...
                      <div className="paragraf">
                        <strong>Axebug:</strong> So let’s fold the paper and
                        match a point to b.
                      </div>
                      <div className="paragraf">
                        <strong>Axebug:</strong> The wormhole{" "}
                        <input
                          className="form-input textformat"
                          type="text"
                  ...
                  {pageNo === 2 ? (
                    <React.Fragment>
                      ...
                      <div className="row">
                        <div className="col-2"> 1. Explain</div>
                        <div className="col-1">
                          <input
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>A. </strong> An object or a shape measured
                            in three different ways, height, length, width
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-2"> 2. Sphere</div>
                        <div className="col-1">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>B. </strong> To bend or twist a type of
                            shape.
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-2"> 3. Warp</div>
                        <div className="col-1">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>C. </strong> To give information about.
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-2"> 4. 3 Dimensional</div>
                        <div className="col-1">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>D. </strong> A round figure of geometry.
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-2"> 5. Remember</div>
                        <div className="col-1">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>E. </strong> To have something in your mind
                            or bring something back into your mind.
                          </div>
                        </div>
                      </div>
                    </React.Fragment>
                  ...
                  {pageNo === 4 ? (
                    <React.Fragment>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p030_001_c2_e5.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p037_001_c2_e5.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p042_002_c2_e6.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p077_001_c2_e6.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
