            ...
            <div className="card mt-5 mb-5">
                <div className="card-header">
                    <div className="d-flex justify-content-center">
                        <h1><strong>  QUIZ CHAPTER 3 EPISODE 12</strong></h1>
                                    ...
                                    <div style={{ fontSize: "18pt" }}>
                                        {
                                            pageNo === 0 ?
                                                <React.Fragment>
                                                    ...
                                                    <div className='row'>
                                                        <strong>1. How many days does the travel take in earth time?</strong>
                                                    ...
                                                    <div className='row'>
                                                        <strong>2. The journey gets shorter if they use ____________.</strong>
                                                        <div className="form-check">
                                                    ...
                                                    <div className='row'>
                                                        <strong>3. What is the reason for the time difference between going there and coming back?</strong>
                                                        <div className="form-check">
                                                        ...
                                                        <div className="form-check">
                                                            ...
                                                            <label className="form-check-label" htmlFor="flexRadioDefault1">
                                                                D) Because they will come back using a different route.
                                                            </label>
                                                        </div>
                                                    </div>

                                                    <div className='row'>
                                                        <strong>4. Why should they target their point before the departure according to Axebug?</strong>
                                                        <div className="form-check">
                                                            <input className="form-check-input" type="radio" name="as4" onChange={(e) => setStudentOpenAnswer(0, 0, 4, "A")} />
                                                            <label className="form-check-label" htmlFor="flexRadioDefault1">
                                                                A) Because Axebug wants to have a well-organized trip.
                                                            </label>
                                                        </div>
                                                        <div className="form-check">
                                                        ...
                                                        <div className="form-check">
                                                            ...
                                                            <label className="form-check-label" htmlFor="flexRadioDefault1">
                                                                C) Because the Dung Beetle wants to go back to Earth before Christmas.
                                                            </label>
                                                        </div>
                                                        <div className="form-check">
                                                ...
                                                <React.Fragment>
                                                    ...
                                                    <div className="alert alert-dark" role="alert">
                                                        <audio controls className='w-100' style={{ backgroundColor: "black", height: 45 }}>
                                                            <source src={`../../assets/quiz_12_listeng.mp3`} type="audio/mpeg" />
                                                        </audio>
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Axebug:</strong> So, we should target our point before we start our journey. Otherwise we will get  <input className="form-input textformat" type="text" value={answer.result[0][1][1].student} onChange={(e) => setStudentOpenAnswer(0, 1, 1, e.target.value, true)} />
                                                        .
                                                    </div>
                                                    <div className="paragraf">
                                                    ...
                                                    <div className="paragraf">
                                                        <strong>Axebug: </strong>There is a <input className="form-input textformat" type="text" value={answer.result[0][1][2].student} onChange={(e) => setStudentOpenAnswer(0, 1, 2, e.target.value, true)} />
                                                        between days because of the actions in cosmos.
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Dun beetle: </strong> We should follow all the actions very     <input className="form-input textformat" type="text" value={answer.result[0][1][3].student} onChange={(e) => setStudentOpenAnswer(0, 1, 3, e.target.value, true)} />
                                                        . 
                                                    </div>
                                                    ...
                                                    <div className="paragraf">
                                                        <strong>Ladybug: </strong>That means we can  <input className="form-input textformat" type="text" value={answer.result[0][1][4].student} onChange={(e) => setStudentOpenAnswer(0, 1, 4, e.target.value, true)} />
                                                        where we will land too.
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Robug 13: </strong>So, I think we are all<input className="form-input textformat" type="text" value={answer.result[0][1][5].student} onChange={(e) => setStudentOpenAnswer(0, 1, 5, e.target.value, true)} />
                                                        clear.
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Robug 13:</strong> Let’s take a rest, then we will meet at the<input className="form-input textformat" type="text" value={answer.result[0][1][5].student} onChange={(e) => setStudentOpenAnswer(0, 1, 5, e.target.value, true)} />
                                                       area.
                                                    </div>
                                                    <div className="paragraf">
                                                    ...
                                                    <div className="paragraf">
                                                        <strong>Dun beetle: </strong>My favorite time! Let’s take<input className="form-input textformat" type="text" value={answer.result[0][1][5].student} onChange={(e) => setStudentOpenAnswer(0, 1, 5, e.target.value, true)} />
                                                        .
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Black Writing:</strong>12 hours later. 5 Minutes to departure. Earth time 9 o’clock
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Robug 13:</strong>  It’s time. Let’s begin. You can board to ‘zzz55’.
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Robug 13:</strong>From now on, we will run this ship with a <input className="form-input textformat" type="text" value={answer.result[0][1][7].student} onChange={(e) => setStudentOpenAnswer(0, 1, 7, e.target.value, true)} />
                                                    ...
                                                    <div className="paragraf">
                                                        <strong>Watchman 1:</strong>  There is a robot in ‘zzz55’ to assist you. 
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Axebug:</strong> All set! Waiting for your  <input className="form-input textformat" type="text" value={answer.result[0][1][7].student} onChange={(e) => setStudentOpenAnswer(0, 1, 7, e.target.value, true)} />
                                                        , tower! 
                                                    </div>
                                                    <div className="paragraf">
                                                    ...
                                                    <div className="paragraf">
                                                        <strong>Ladybug:</strong> Engine ready. We are launching.
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Watchman 2:</strong> Ready
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Watchman 1:</strong> 3,2,1! You can<input className="form-input textformat" type="text" value={answer.result[0][1][7].student} onChange={(e) => setStudentOpenAnswer(0, 1, 7, e.target.value, true)} />
                                                        .
                                                    </div>
                                                    <div className="paragraf">
                                                        <strong>Robug 13:</strong> That’s the 10th spaceship for this task. I hope we will make it to the top this time…
                                                    </div>
                                            ...
                                            pageNo === 2 ?
                                                <React.Fragment>
                                                    ...
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-9'>
                                                            <div className="paragraf alert alert-success"><strong>B. </strong> A great success, just like winning the lottery.</div>
                                                        </div>
                                                    </div>
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-9'>
                                                            <div className="paragraf alert alert-success"><strong>C. </strong> An assignment or a duty to be accomplished.</div>
                                                        </div>
                                                    </div>
                                                    <div className='row'>
                                                        ...
                                                        <div className='col-9'>
                                                            <div className="paragraf alert alert-success"><strong>D. </strong> An exact thing.</div>
                                                        </div>
                                                    </div>
                                                    <div className='row'>
                                        ...
                                        }
                                        {
                                            pageNo === 4 ?
                                                <React.Fragment>
                                                    ...
                                                    <div className="alert alert-dark" role="alert">
                                                        <audio controls className='w-100' style={{ backgroundColor: "black", height: 45 }}>
                                                            <source src={`../../assets/c3_e12_pg26_p2.mp3`} type="audio/mpeg" />
                                                        </audio>
                                                    </div>
                                                    ...
                                                    <div className="alert alert-dark" role="alert">
                                                        <audio controls className='w-100' style={{ backgroundColor: "black", height: 45 }}>
                                                            <source src={`../../assets/c3_e12_pg27_p4.mp3`} type="audio/mpeg" />
                                                        </audio>
                                                    </div>
                                                    <div className='border border-success p-3 mt-3'>
                                                    ...
                                                    <div className="alert alert-dark" role="alert">
                                                        <audio controls className='w-100' style={{ backgroundColor: "black", height: 45 }}>
                                                            <source src={`../../assets/c3_e12_pg27_p10.mp3`} type="audio/mpeg" />
                                                        </audio>
                                                    </div>
                                                    <div className='border border-success p-3 mt-3'>
                                                    ...
                                                    <div className="alert alert-dark" role="alert">
                                                        <audio controls className='w-100' style={{ backgroundColor: "black", height: 45 }}>
                                                            <source src={`../../assets/c3_e12_pg29_p3.mp3`} type="audio/mpeg" />
                                                        </audio>
                                                    </div>
                                                    <div className='border border-success p-3 mt-3'>
