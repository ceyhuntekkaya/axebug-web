      ...
      <div className="card mt-5 mb-5">
        <div className="card-header">
          <div className="d-flex justify-content-center">
            <h1>
              <strong> QUIZ CHAPTER 1 EPISODE 3</strong>
            </h1>
          </div>
        </div>
                ...
                <div style={{ fontSize: "18pt" }}>
                  ...
                  {pageNo === 1 ? (
                    <React.Fragment>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/quiz_listening_c1_e3.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="paragraf">
                        ...
                        />{" "}
                        guys. We are in the space at last.
                      </div>
                      <div className="paragraf">
                      ...
                      <div className="paragraf">
                        ...
                        />{" "}
                        lets hang a left now. But first...
                      </div>
                      <div className="paragraf">
                      ...
                      <div className="paragraf">
                        <strong>Axebug:</strong> The solar system has the sun
                        and the planets
                        <input
                          className="form-input textformat"
                          type="text"
                          value={answer.result[0][1][14].student}
                          onChange={(e) =>
                            setStudentOpenAnswer(0, 1, 14, e.target.value, true)
                          }
                        />{" "}
                        around it.
                      </div>{" "}
                  ...
                  {pageNo === 2 ? (
                    <React.Fragment>
                      ...
                      <div className="row">
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>A. </strong> A high possibility, probability
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-9">
                          <div className="paragraf alert alert-success">
                            <strong>B. </strong> A hopeless search for something
                          </div>
                        </div>
                      </div>
                      <div className="row">
                      ...
                      <hr />
                      <div className="row">
                        <div className="col-2"> Suddenly</div>
                        <div className="col-2">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-8">Move in a circular shape</div>
                      </div>
                      <div className="row">
                        <div className="col-2"> Pitch – Black</div>
                        <div className="col-2">
                          <input
                            className="form-input w-100"
                            type="text"
                      ...
                      <div className="row">
                        <div className="col-2"> Locate</div>
                        <div className="col-2">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-8">Very dark</div>
                      </div>
                      <div className="row">
                        <div className="col-2"> Revolve</div>
                        <div className="col-2">
                          <input
                            className="form-input w-100"
                            type="text"
                      ...
                      <div className="row">
                        <div className="col-2"> Spectacular</div>
                        <div className="col-2">
                          <input
                            className="form-input w-100"
                            type="text"
                        ...
                        <div className="col-8">All very quick</div>
                      </div>
                    </React.Fragment>
                  ) : null}
                  {pageNo === 3 ? (
                  ...
                  {pageNo === 4 ? (
                    <React.Fragment>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p076_01_c1e3.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p079_01_c1e3.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p086_03_c1e4.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
                      ...
                      <div className="alert alert-dark" role="alert">
                        ...
                        >
                          <source
                            src={`https://axebug.s3.eu-central-1.amazonaws.com/assets/p091_02_c1e4.mp3`}
                            type="audio/mpeg"
                          />
                        </audio>
                      </div>
