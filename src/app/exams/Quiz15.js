                                    ...
                                    {pageNo === 1 ? (
                                        <React.Fragment>
                                            ...
                                            <div className="alert alert-dark" role="alert">
                                                ...
                                                >
                                                    <source
                                                        src={getFileUrl('ouiz_15_listening.mp3')}
                                                        type="audio/mpeg"
                                                    />
                                                </audio>
                                            </div>
                                            ...
                                            <div className="paragraf">
                                                <strong>AXEBUG: </strong>Light speed travels at 300.000km per
                                            ...
                                            <div className="paragraf">
                                                <strong>DUNG BEETLE : </strong> What if we stabilized our speed to
                                                300.000km
                                                <input
                                                    className="form-input textformat"
                                                    type="text"
                                    ...
                                    {pageNo === 2 ? (
                                        <React.Fragment>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-9">
                                                    <div className="paragraf alert alert-success">
                                                        <strong>A. </strong> A large, powerful light at the front of a
                                                        vehicle to illuminate the road ahead.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-9">
                                                    <div className="paragraf alert alert-success">
                                                        <strong>C. </strong> C. To make something clear or easier to
                                                        understand, to define.
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="row">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-9">
                                                    <div className="paragraf alert alert-success">
                                                        <strong>E. </strong> Time differance difference caused by
                                                        gravitational forces and speed.
                                                    </div>
                                                </div>
                                            </div>
                                        </React.Fragment>
                                    ...
                                    {pageNo === 4 ? (
                                        <React.Fragment>
                                            ...
                                            <div className="alert alert-dark" role="alert">
                                                ...
                                                >
                                                    <source
                                                        src={getFileUrl('c4_e15_pg20_p5.mp3')}
                                                        type="audio/mpeg"
                                                    />
                                                </audio>
                                            </div>
                                            ...
                                            <div className="alert alert-dark" role="alert">
                                                ...
                                                >
                                                    <source
                                                        src={getFileUrl('c4_e15_pg20_p6.mp3')}
                                                        type="audio/mpeg"
                                                    />
                                                </audio>
                                            </div>
                                            ...
                                            <div className="alert alert-dark" role="alert">
                                                ...
                                                >
                                                    <source
                                                        src={getFileUrl('c4_e15_pg20_p15.mp3')}
                                                        type="audio/mpeg"
                                                    />
                                                </audio>
                                            </div>
                                            ...
                                            <div className="alert alert-dark" role="alert">
                                                ...
                                                >
                                                    <source
                                                        src={getFileUrl('c4_e15_pg21_p7_8.mp3')}
                                                        type="audio/mpeg"
                                                    />
                                                </audio>
                                            </div>
