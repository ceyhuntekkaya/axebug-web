  ...
  return (
      <React.Fragment>
          <div className="container">
              ...
              <div className="border border-2 border-dark p-2 mt-2 d-flex justify-content-center" style={{ width: 350 }}><h2><b>QUIZ</b></h2></div>
          </div>
              ...
              <div className='row' style={{ width: 750 }}>
                  {
                      examList.map((exam, key) =>
                          exam.ready === true ?
                              <Square col="3" key={key} to={`../../app/quiz/${exam.id}`} backgroundColor="black"><h1><b>{exam.name}</b></h1> </Square>
                              :
